...
class IntentString {
	...
	@Override
	public IntentString clone() {
		IntentString intent = new IntentString();
	...
	public List<Component> resolve(List<Component> list, String app) {
...
//				}
	...
	public Map<String, List<Component>> resolve(Map<String, List<Component>> componentsPerApp) {
		Map<String, List<Component>> result = new HashMap<String, List<Component>>();
		for (String app: componentsPerApp.keySet()) {
			List<Component> resPerApp = resolve(componentsPerApp.get(app), app);
			if(resPerApp.size() > 0) {
